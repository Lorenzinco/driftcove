  ...
  <v-dialog v-model="open" max-width="520">
    <v-card v-if="subnet">
      <v-card-title class="d-flex justify-space-between align-center">
        <span
          ><v-icon icon="mdi-subnet" size="24"></v-icon>{{ subnet.name }} ({{
            subnet.cidr
          }})</span
        >
            ...
            <v-expansion-panels class="w-100" multiple>
              ...
              >
                ...
                <v-expansion-panel-text class="pt-0">
                  <div v-if="!peersInside.length" class="text-medium-emphasis">
                    No peers
                  </div>
                    ...
                    >
                      ...
                      >
                        <v-icon
                          ...
                          class="text-primary"
                        />{{ svc.serviceName
                        }}<span v-if="svc.port"> : {{ svc.port }}</span
                        ><span v-if="svc.protocol"> ({{ svc.protocol }})</span>
                      </v-list-item-title>
                      <v-list-item-subtitle>
                        Host: {{ svc.hostName }}
              ...
              >
                ...
                <v-expansion-panel-text class="pt-0">
                  <div v-if="!guestPeers.length" class="text-medium-emphasis">
                    No guests
                  </div>
                  <v-list v-else density="compact" nav class="py-0">
                    <v-list-item
      ...
      <v-card-actions>
        <v-spacer />
        <v-btn color="primary" variant="elevated" @click="open = false"
          >Close</v-btn
        >
      </v-card-actions>
    </v-card>
