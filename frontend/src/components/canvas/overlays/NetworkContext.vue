<template>
  ...
  <div v-if="menu.open" class="network-menu-backdrop" @click="hideMenu" @mousedown.stop />
</template>
<script setup lang="ts">
  ...
  function showMenu (payload: { x: number, y: number }) {
    menu.open = true; menu.x = payload.x; menu.y = payload.y
  }
  function hideMenu () {
    menu.open = false
  }
